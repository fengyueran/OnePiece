...
export function fade(color, value) {
  warning(color, `Missing color argument in fade(${color}, ${value}).`);
...
export function darken(color, coefficient) {
  warning(color, `Missing color argument in darken(${color}, ${coefficient}).`);
...
export function lighten(color, coefficient) {
  warning(color, `Missing color argument in lighten(${color}, ${coefficient}).`);
